...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView itemHobby;
  ...
  private VerticalHorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView itemAge, @NonNull TextView itemHobby, @NonNull ImageView itemImage,
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.item_hobby;
      TextView itemHobby = ViewBindings.findChildViewById(rootView, id);
      if (itemHobby == null) {
        break missingId;
      }
      ...
      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, itemAge, itemHobby,
          itemImage, itemName);
    }
