...
public final class GridListItemBinding implements ViewBinding {
  ...
  private GridListItemBinding(@NonNull MaterialCardView rootView, @NonNull TextView itemAge,
      @NonNull TextView itemHobby, @NonNull ImageView itemImage, @NonNull TextView itemName) {
  ...
  public static GridListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new GridListItemBinding((MaterialCardView) rootView, itemAge, itemHobby, itemImage,
          itemName);
    }
